...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        try {
            ...
            while(rs.next()) {
                labelname.setText(rs.getString("Lastname"));
        ...
        String branch[] = {"Macroeconomics","Computer Science", "Electronics", "Mechanical", "Civil", "IT","Calculus","Trigonometry"};
        ...
        String semester[] = {"Semester1", "Semester2", "Semester3" };
